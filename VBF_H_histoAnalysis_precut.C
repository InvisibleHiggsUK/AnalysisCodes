...
void VBF_H_histoAnalysis_precut()
{
  ...
  TString dirname = ".";
  TString rootname = Dataset::fullDatasetName(id);
  //  TString rootname = "VBF_invH_8000_precut_outputNEW.root";
  ...
  // For TH1D histograms
  TString plots = "InvMass_precut,DeltaEta_precut,DeltaPhi_precut,JetPT1_precut,JetPT2_precut,JetEta1_precut,JetEta2_precut,EtaDP_precut,MET_precut,CJPt_precut,CJEt_precut";
  ...
  */
  ...
  c1.cd();
  c1.SaveAs(Dataset::pdfTitler(id)+"_HistoBoard_rebinned.pdf");
  ...
  for(int i=0; i<n; i++)
    {
      ...
      hi->Draw(style);
      gPad->SetLogy();
      c2.Print("VBF_invH_8TeV_preCut_Histos.pdf(");
  ...
  c1.cd();
  c1.SaveAs("VBF_invH_8TeV_preCut_HistoBoard_rebinned.pdf");
